            ...
            <tbody>
                @foreach ($packages as $item)
                    <tr>
                        ...
                        <td>
                        <img src="{{ asset('storage/back/' . $item->image) }}" alt="{{ $item->name }}" style="width: 100px; height: auto;">
                        </td>
                        <td >
                        ...
                        <td>
                            <div class="d-flex flex-column flex-sm-row gap-1 text-center justify-content-center   ">
                                <a href="{{ url('admin/packages/' . $item->id ) }}" class="btn btn-secondary w-sm-auto"><i class="fa-solid fa-circle-info"></i></a>
                                <a href="{{ url('admin/packages/' . $item->id . '/edit' ) }}" class="btn btn-primary w-sm-auto"><i class="fa-solid fa-pen-to-square"></i></a>
                                <a href="#" class="btn btn-danger w-sm-auto" onclick="deletePackage(event, this)" data-id="{{ $item->id }}"><i class="fa-solid fa-trash"></i></a>
                            </div>
                        </td>
                    </tr>
                @endforeach
